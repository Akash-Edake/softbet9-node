...
const liveCricketMatches = async (req, res) => {
  ...
  try {
    ...
    return res.status(200).json({ status: 1, dataobj: results1 });
  } catch (error) {
...
module.exports ={liveCricketMatches,upcommingCricketMatches,completedCricketMatches,inplayMatchesForAllSports,getMatchDetails}
